          ...
          {todayWellness ? (
                  ...
                  {(() => {
                    ...
                    return (
                      <Icon
                        className={cn(
                          "w-12 h-12",
                          wellnessConfig[todayWellness.level].color,
                        )}
                      />
                    );
                  })()}
            ...
            <div className="flex flex-col items-center justify-center py-8 text-center">
              ...
              <p className="text-sm text-muted-foreground mt-1">
                Check-ins are usually logged by the care receiver
              </p>
            </div>
          )}
        </section>
          ...
          <section className="lg:col-span-1 bg-card border-2 border-border rounded-3xl p-8 shadow-sm">
            ...
            {mostCommon ? (
              <div className="space-y-6">
                <div className="p-4 bg-secondary/30 rounded-2xl">
                  ...
                  <p
                    className={cn(
                      "text-xl font-bold",
                      wellnessConfig[mostCommon].color,
                    )}
                  >
                ...
                <div className="space-y-3">
                  ...
                  {(["great", "okay", "notGreat"] as WellnessLevel[]).map(
                    (level) => {
                      ...
                      const percent =
                        trend.length > 0 ? (count / trend.length) * 100 : 0;
                      return (
              ...
              <p className="text-muted-foreground italic">
                Insufficient data to generate a weekly summary.
              </p>
            )}
          </section>
