        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground text-sm">
              Performance and adherence tracking
            </p>
          </div>
        </div>
        <button
