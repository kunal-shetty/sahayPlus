        ...
        <div className="flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground text-sm">
              Manage pharmacy contacts and medication refill notes
            </p>
          </div>
        </div>
      </header>
          ...
          <div className="p-6 border-b border-border flex items-center justify-between">
            <div>
              ...
              <p className="text-sm text-muted-foreground">
                Notes provided by the pharmacist for each medication
              </p>
            </div>
          </div>
    ...
    <tr className="hover:bg-secondary/30 transition-colors">
      <td className="px-6 py-4">
        <div className="flex items-center gap-3">
          <div
            className={`w-2 h-2 rounded-full ${med.taken ? "bg-sahay-success" : "bg-sahay-pending"}`}
          />
      ...
      <td className="px-6 py-4">
        {isEditing ? (
          ...
          <div className="flex items-center gap-3">
            ...
            {med.pharmacistNote && (
              <div className="w-1.5 h-1.5 rounded-full bg-sahay-blue" />
            )}
          </div>
        )}
      </td>
