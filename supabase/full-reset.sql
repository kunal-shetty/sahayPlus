-- =============================================================================
-- Sahay+ — Database FULL RESET
-- Drops every public object and rebuilds the schema in a single paste.
--
-- ⚠️  DESTRUCTIVE: every row in every public table will be deleted.
-- auth.users rows are left alone so the project itself keeps existing.
--
...
-- ============================================================================
-- PART 1 — DROP EVERYTHING  (verbatim from supabase/reset.sql)
-- ============================================================================
...
-- ============================================================================
-- PART 2 — RECREATE EVERYTHING  (verbatim from supabase/schema.sql)
-- ============================================================================
